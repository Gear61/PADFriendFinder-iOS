...
class Constants
{
    ...
    static let MONSTER_ID_KEY = "monsterId"
    ...
    static let GET_MONSTERS_KEY = "getMonsters"
    ...
    // Homepage
    static let LOADING_MONSTER_LIST_MESSAGE = "Loading monster list, please wait..."
    static let MONSTER_LIST_LOADED_MESSAGE = "Monster list loaded."
    static let MONSTER_LIST_FAILED_MESSAGE = "Failed to load monster list. Please try using the app again later."
